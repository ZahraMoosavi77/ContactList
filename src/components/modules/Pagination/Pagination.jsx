    ...
    <div className="flex flex-col items-center">
      ...
      <div className="inline-flex mt-2 xs:mt-0">
        <button
          ...
          className="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 rounded-s
           hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700
        ...
        <button
          ...
          className="flex items-center justify-center px-3 h-8 text-sm font-medium text-white
